...
const ProfileCard = ({ data, onList }) => {
  ...
  return (
    <div
      className="flex-col flex space-y-3 border border-slate-300/50 bg-slate-100 dark:border-slate-600/50 shadow-lg
     dark:bg-slate-800 p-2 rounded-xl "
    >
      <div className=" flex-col sm:flex-row flex gap-3  overflow-hidden">
        {data.image ? (
          <img
            src={`/upload/profile/${data.image ? data.image : ProfileDefault}`}
            alt=""
